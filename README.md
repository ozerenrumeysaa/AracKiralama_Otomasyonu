...
Veritabanı Yönetimi: CRUD operasyonları için Stored Procedures (Saklı Yordamlar) kullanılmıştır.
Tasarım / UI: Hiçbir dış eklenti kullanılmadan, C# GraphicsPath kütüphanesi ile sıfırdan yazılmış yuvarlak köşeli araçlar ve özel şeffaf paneller.
